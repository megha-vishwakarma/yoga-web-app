...
<nav class="navbar navbar-light bg-light">
    ...
    <img src="https://img.freepik.com/free-vector/yoga-logo-design-human-meditation-lotus-flower-logo-design_121524-126.jpg?size=626&ext=jpg" width="200"  class="d-inline-block align-top" alt="">
    Yoga School
  </a>
  ...
  <a href="logout.php" class="btn btn-primary"><i class="fa fa-lock-open"></i> Logout</a>
    ...
    <div class="page-header">
        <h1>Hi, <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>. Welcome to Yoga Classes</h1>
    </div>
    <hr>
    </div>
